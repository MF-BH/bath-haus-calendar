...
TRANSMISSION (monthly letter — this is the heart of the calendar):
  ...
  - Para 3 (GENE KEYS — 160-200 words): Write in Richard Rudd's voice. Name the specific gates moving
...
AFFIRMATION:
  ...
  Should feel like it came from a session with Richard Rudd — pointing toward the Gift of their
  Life's Work gate ({chart['gk_life_work_label'].split(' — ')[0] if ' — ' in chart['gk_life_work_label'] else 'their Gene Keys'}).
...
{{
  ...
  "closing_note": "one sentence preview of next month, referencing what seeds were planted this month"
}}
